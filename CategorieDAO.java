...
public class CategorieDAO extends DAO<Categorie> {
       ...
       String  libelle = obj.getLibelle();
        ...
        try {
            this.connect.createStatement(
                    ...
                    ResultSet.CONCUR_READ_ONLY).executeUpdate("INSERT INTO `categorie` (`LIBELLE`) VALUES ('"+libelle+"');" );
    ...
    public Categorie delete(Categorie obj){
        ...
        try {
            ...
            this.connect.createStatement(
                    ResultSet.TYPE_SCROLL_INSENSITIVE,
                    ResultSet.CONCUR_READ_ONLY).executeUpdate("DELETE FROM `categorie` WHERE `LIBELLE` = '"+libelle+"'");
